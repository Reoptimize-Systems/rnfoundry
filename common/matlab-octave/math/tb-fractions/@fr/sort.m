...
% fr/SORT: Sorts a fraction array in ascending or descending order.
%
...
%
%  Version history:
%    28/7/2009 (Ben Petschel) - updated documentation only (works find with
%    any object type for which "<=" and ">=" are defined)
