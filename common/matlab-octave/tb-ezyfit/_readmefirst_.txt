...
EzyFit needs Matlab 7.0 or higher. It has been tested under 7.0 to 7.10
(R2010a), but mainly under Windows XP. The command-line functions (e.g.
...
My Documents/MATLAB/toolbox/ezyfit may be a good location. Do NOT install
...
4. If you want to always have the Ezyfit menu in your figures, type
...
installation, you just have to follow the steps 2-4.
