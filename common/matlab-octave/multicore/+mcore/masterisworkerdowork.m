...
%
    ...
    % directory
    parameterFileExisting = mcore.existfile(paramfname);
    ...
    if parameterFileExisting
        ...
        mcore.mbdelete2(paramfname, settings.showWarnings);
        if settings.debugMode
    ...
    if parameterFileExisting
        ...
        [mcstate, resultCell, sem, resultLoaded] = ...
            mcore.masterwaitforresult(mcstate, settings, resultCell, ...
    ...
    if ~resultLoaded
        ...
        [mcstate, resultCell] = mcore.mastereval(mcstate, settings, evalfcns, fcnparams, resultCell);
    end
