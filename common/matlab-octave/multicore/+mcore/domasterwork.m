...
%             end
            ...
            if debugMode, t1 = mcore.mbtime; end

            sem = mcore.setfilesemaphore(parameterFileName, showWarnings, debugMode, 0, dirtdiff);

            if debugMode, setTime = setTime + mbtime - t1; end

            parameterFileExisting = mcore.existfile(parameterFileName);
            ...
            if parameterFileExisting
                ...
                mcore.mbdelete2(parameterFileName, showWarnings);
                if debugMode
            ...
            if parameterFileExisting
                ...
                while 1 
                    ...
                    % result file.
                    if mcore.existfile(resultFileName)
                        % attempt to load the result from result file
                        [result, resultLoaded] = mcore.loadResultFile2(resultFileName, showWarnings);
...
%                         multicoreWaitbar('update2', nrOfFiles, nrOfFilesMaster, nrOfFilesSlaves);
                    ...
                    if mcore.existfile(workingFileName)
                        ...
                        jobTimedOut = mbtime - mcore.getfiledate(workingFileName) * 86400 > maxMasterWaitTime;
                    else
