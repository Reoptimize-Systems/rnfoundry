function [mcstate, resultCell] = checkforresults(mcstate, settings, evalfcns, fcnparams, resultCell)
        ...
        if resultLoaded
            ...
            if parameterFileExisting
                ...
                if ~isnan(mcstate.parameterFileFoundTime)
                    ...
                    % to be alive.
                    jobTimedOut = mcore.mbtime() - mcstate.parameterFileFoundTime > mcstate.maxMasterWaitTime;
                else
                    % Remember the current time to decide later if the job has timed out.
                    mcstate.parameterFileFoundTime = mcore.mbtime();
                    jobTimedOut = false;
                end
            else
                if settings.debugMode
            ...
            if jobTimedOut
                ...
                if parameterFileExisting
                    ...
                    mcstate = mcore.resubmitparams(mcstate, settings, ...
                ...
                if (parameterFileExisting  || mcstate.parameterFileRegCounter > 2) && settings.masterIsWorker
                    ...
                    % is a worker.
                    [mcstate, resultCell] = ...
                        mcore.mastereval(mcstate, settings, evalfcns, fcnparams, resultCell);
