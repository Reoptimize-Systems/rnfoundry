function I = Table1r2I_2(IVars)
% Table1r2I_2: Calculates the second moment of inertia of a beam with a
% rectangular cross-section, as calculated in 'Roark's Formulas Stress &
% Strain 6th edition' in table 1, page 62 row 2. 
%
%             2
%             .
%        _____._______
