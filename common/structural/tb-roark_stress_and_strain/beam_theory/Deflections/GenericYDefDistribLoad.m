function yDef = GenericYDefDistribLoad(thetaA, MA, RA, wa, wl, x, l, a, yA, E, I)
% GenericYDefDistribLoad: Calculates the deflection of a beam with some
% distributed loading using the generic deflection formula for distributed
