function CMM = CMMcoeff(l1, E1, I1, l2, E2, I2, l3, E3, I3)
% CMMcoeff: calculates the CMM coefficient for a frame with it's right side
...
%
    CMM = l1./(E1.*I1) + l2./(E2.*I2) + l3./(E3.*I3); 
