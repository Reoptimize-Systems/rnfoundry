function sigma = UniformInternalPressEndsCapped (vars)
...
% This function is based on the formulas in in "Roark's Formulas for Stress
% and Strain".
%
% Syntax
%
% sigma = UniformInternalPressEndsCapped (vars)
%
% Input: 
%   
%   vars - (n x 4) matrix:-
