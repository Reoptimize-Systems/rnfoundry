classdef absoluteCouple < mbdyn.pre.structuralCouple
    ...
    methods
        ...
        function self = absoluteCouple (node, couple_value, varargin)
            % <force_arglist> ::=
            % <node_label> ,
        ...
        function str = generateOutputString (self)
            ...
            str = self.addOutputLine (str, ';', 1, false, 'end absolute structural couple');
