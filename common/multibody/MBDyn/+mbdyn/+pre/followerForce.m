classdef followerForce < mbdyn.pre.structuralForce
    ...
    methods
        ...
        function self = followerForce (node, position, force)
            % <force_arglist> ::=
            % <node_label> ,
        ...
        function str = generateOutputString (self)
            ...
            str = self.addOutputLine (str, ';', 1, false, 'end follower structural force');
