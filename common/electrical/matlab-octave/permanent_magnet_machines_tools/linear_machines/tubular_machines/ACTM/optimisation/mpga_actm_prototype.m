...
OBJ_F = 'objactm_prototype';   % Name of function for objective values
...
SUBPOP = 4;                       % Number of subpopulations
NIND = 100;                        % Number of individuals per subpopulations
MAXGEN = 5000; % Max number of generations
...
filename = 'objactm_prototype_output.mat';
