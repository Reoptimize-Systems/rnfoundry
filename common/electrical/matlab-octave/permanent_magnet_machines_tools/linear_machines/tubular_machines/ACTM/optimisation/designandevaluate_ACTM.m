...
% Input:
%
%   design structure containing the following members:
%
...
%                            evaluating a machine and buoy system (default:
%                            0.2)
%
...
%
%   design - a sturcture containing detailed information on the
%            machine design
%
    ...
    simoptions.evaloptions = designandevaloptions_ACTM( simoptions.evaloptions);
    ...
    design = designstructure_ACTM(design,  simoptions.evaloptions);
