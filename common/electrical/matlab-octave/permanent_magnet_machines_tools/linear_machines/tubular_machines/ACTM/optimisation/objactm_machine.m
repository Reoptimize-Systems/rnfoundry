function ObjVal = objactm_machine(Chrom, rtn_type, simoptions, multicoredir)
...
% Copyright Richard Crozer, The University of Edinburgh
   ...
   FieldBounds = [ 0.05,  0.95;   %  1. WmVWp
                   ...
                   0.01,  1.0;    %  8. Rm
                   0.5,   15.0;   %  9. RgVRc
                   0.2,   0.65;   % 10. CoilFillFactor
                   0,     1;      % 11. DcAreaFac
                   10,    200;    % 12. TransPoles
                   0,     1;      % 13. BranchFac
                   0,     5;      % 14. bpoints
                   1,     10;     % 15. NoOfMachines
                   1,     20 ];   % 16. maxAllowedxT Factor 
...
% Check size of Chrom and do the appropriate thing
   ...
   elseif Nvar == Dim
       ...
       if nargin < 4
           ...
           multicoredir = fullfile(actmrootdir, 'Temp');
           
       end
       
       ObjVal = objelectricalmachine(simoptions, Chrom, ...
                                     'preprocsystemdesign_ACTM' , ...
                                     'designandevaluate_ACTM', ...
                                     multicoredir);
