% mpga_actiam_prototype_steeldiscs.m         (Multi Population Genetic Algorithm)
%
...
OBJ_F = 'objactiam_prototype_steeldiscs';   % Name of function for objective values
...
filename = fullfile(getmfilepath('mpga_actiam_prototype'), 'objactiam_prototype_steeldiscs_output_1.mat');

resumefile = 'objactiam_prototype_steeldiscs_output_0.mat';
