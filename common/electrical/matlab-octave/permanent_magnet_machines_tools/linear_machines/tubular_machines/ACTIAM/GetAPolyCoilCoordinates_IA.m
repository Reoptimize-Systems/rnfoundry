function [BCoordinates, r] = GetAPolyCoilCoordinates_IA(RoVRm, cwVWp, Sr, Sz, pos, Wp, Rm, g)
...
%           other values up to ch/Wp = 1 possible) for machine to be
%           evaluated
%        
...
%
%   g - Scalar value of distance of coils above the translator surface
%       
%
% Arguments: (output)
%
%   BCoordinates - (n x 3) array of r,z coordinates for calculating
%                  the average flux at several coil positions. The rows of
%                  the first column of the array are the r coordinates and
%                  the rows of the second column are the corresponding z
%                  coordinates. Each matrix in the third dimension
%                  corresponds to each position in pos.
%
