function design = completedesign_TM_SLOTLESS (design, simoptions, setchoice)
% converts a minimal design specification to a complete design suitable for
% use by simfun_TM_SLOTLESS
%
% Syntax
%
% design = completedesign_TM_SLOTLESS (design, simoptions, setchoice)
%
% Description
%
...
%
    ...
    tempdesign = design;
    tempdesign = rmiffield (tempdesign, 'MagFEASimMaterials');
    
    % replace all the materials with air
    tempdesign.MagFEASimMaterials.AirGap = 'Air';
    tempdesign.MagFEASimMaterials.Magnet = 'Air';
    tempdesign.MagFEASimMaterials.MagnetSpacer = 'Air';
    tempdesign.MagFEASimMaterials.FieldSheath = 'Air';
    tempdesign.MagFEASimMaterials.ArmatureYoke = 'Air';
    tempdesign.MagFEASimMaterials.ArmatureCoil = 'Air';
    
    tempdesign.Dc = 1;

    % Draw the sim, i.e by creating the FemmProblem structure
    [FemmProblem, FieldDrawingInfo, ArmatureDrawingInfo] = ...
                        slotlessfemmprob_tubular (tempdesign, ...
                            'NPolePairs', 1, ...
                            'NWindingLayers', design.CoilLayers, ...
                            'Position', 0, ...
                            'MagnetRegionMeshSize', 100, ...
                            'MagnetSpacerRegionMeshSize', 100, ...
                            'StatorOuterRegionsMeshSize', [100, 100], ...
                            'FieldOuterRegionsMeshSize', [100, 100], ...
                            'AirGapMeshSize', 100, ...
                            'ShoeGapRegionMeshSize', 100, ...
                            'YokeRegionMeshSize', 100, ...
                            'CoilRegionMeshSize', 100, ...
                            'CoilCurrent', zeros (1,design.Phases));

    % swap all materials for air and simulate just to get mesh so we can
    % extract various pieces of info from this, e.g. areas etc.
    ...
    design.CoilArea = solution.blockintegral ( 5, ...
                          ArmatureDrawingInfo.CoilLabelLocations(1,1), ...
                          ArmatureDrawingInfo.CoilLabelLocations(1,2) );
	...
	% complete wire diameter, number of turns and fill factor
