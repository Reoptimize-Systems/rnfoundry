function design = completedesign_TM (design, simoptions)
% performs design creation operations common to all radial flux type rotary
% pm machines
%
% Syntax
%
% design = completedesign_TM(design)
% design = completedesign_TM(design, simoptions)
% 
% Description
%
% completedesign_TM performs some design completion tasks common to all
% tubular linear machines. Most notably it completes the winding specification
...
%
% completedesign_LINEAR also adds further default design options common to all pm
...
%
    ...
    % ignore the winding layout because it's different for tubular machines
    % for now
    warning ('Winding spec ignored for tubular machine');
    
%     design.WindingLayout.Phases = repmat ([1; 2; 3], design.Poles(1), 1);
