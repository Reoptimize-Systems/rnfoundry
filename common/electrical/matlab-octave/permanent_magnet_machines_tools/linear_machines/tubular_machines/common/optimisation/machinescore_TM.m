...
%
    ...
    if all(isfield(design, {'Rs2VHmag', 'Rs1VHmag', 'Ws2VhalfWs', 'Ws1VhalfWs'})) && design.mode == 3
        [poleWeight, steelWeight, magWeight] = ...
            fieldpoleweight_TM(design.WmVWp, design.WpVRm, ...
                           ...
                           design.Rm, simoptions.Evaluation.FieldIronDensity, ...
                           simoptions.Evaluation.MagnetDensity, simoptions.Evaluation.StructMaterialDensity, ...
    ...
    simoptions.Evaluation.nmachines = simoptions.NoOfMachines;
