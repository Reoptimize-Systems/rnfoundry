% Test_lineargen_three_phase_pm_machine_mdl.m
%
%
...
open_system('Test_lineargen_three_phase_pm_machine');

% use the ode15s solver which is more appropriate for electrical machines
set_param('Test_lineargen_three_phase_pm_machine','Solver','ode15s','StopTime','5')
