% Test_machineidealfpto_slotless
...
while xBh < 0.5
    ...
    [EMF(ii, 1:3), Icoils(ii,1:3), limitIcoils(ii,1:3), Force(ii, 1)] = machineidealfpto_slotless(design, simoptions, Fpto, xBh, xBs, vBh, vBs);
...
for ii = 1:numel(Fpto)
    ...
    [EMF(ii, 1:3), Icoils(ii,1:3), limitIcoils(ii,1:3), Force(ii, 1)] = machineidealfpto_slotless(design, simoptions, Fpto(ii), xBh, xBs, vBh, vBs);
    
    ii = ii + 1;
    
end

plot(Fpto, Force); figure(gcf)
...
for ii = 1:numel(xBh)
    ...
    [EMF(ii, 1:3), Icoils(ii,1:3), limitIcoils(ii,1:3), Force(ii, 1)] = machineidealfpto_slotless(design, simoptions, Fpto, xBh(ii), xBs, vBh, vBs);
