...
for i = 1:numel(xEF)
    ...
    [junk, junk, tEMF, tdpsidxCRTF] = machineodesim_AM(design, simoptions, xEF(i), xRE, vEF, vRE, 0);
    
    Icoils(i,:) = tEMF ./ 1;
    
    [FEF(i), FRE(i), EMF(i,:), dpsidxCRTF(i,:)] = machineodesim_AM(design, simoptions, xEF(i), xRE, vEF, vRE, Icoils(i,:));
