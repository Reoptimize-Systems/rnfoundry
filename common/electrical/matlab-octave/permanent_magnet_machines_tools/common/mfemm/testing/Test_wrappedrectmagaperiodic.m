% Test_wrappedrectmagaperiodic

ypole = 1; 
ymag = 0.8;
xmag = 0.2;
xoffset = -4;
wrapperthickness = [0.1, 0.2; 0.1, 0.4; 0.5, 0.5];
...
[FemmProblem, wrapperthickness, leftcentres, rightcentres] = wrappedrectmagaperiodic(FemmProblem, ypole, ...
                                                          ymag, xmag, xoffset, ...
