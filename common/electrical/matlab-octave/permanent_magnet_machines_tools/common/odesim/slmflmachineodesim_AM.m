function [flux_linkage, FEF, FRE, lossinfo, design] = slmflmachineodesim_AM (design, simoptions, xEF, xRE, vEF, vRE, Icoils)
...
%     pos = (((1:design.Phases) .* (1/design.Phases + 1) )  + xCoilRelToField)';
    ...
    % Find flux linkage from an slm object fitted to the flux linkage versus
    ...
    flux_linkage = periodicslmeval (pos, design.slm_fluxlinkage, 0, false);
