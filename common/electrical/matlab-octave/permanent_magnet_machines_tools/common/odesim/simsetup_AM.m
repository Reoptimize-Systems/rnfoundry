...
% performs simulation setup operations common to all mahchine tyels
    ...
    assert (~(Inputs.ForceAddPhaseCurrentODESolutionComps && Inputs.NoAddPhaseCurrentODESolutionComps), ...
        'Both ForceAddPhaseCurrentODESolutionComps and NoAddPhaseCurrentODESolutionComps are true.' );
    assert (~(Inputs.ForceAddDQCurrentODESolutionComps && Inputs.NoAddDQCurrentODESolutionComps), ...
