function [design, simoptions] = simfun_RADIAL_SLOTLESS(design, simoptions)
% generates simulation data for a radial flux slotless machine in
% preparation for a time series ode simulation
%
% Syntax
%
% [design, simoptions] = simfun_RADIAL_SLOTLESS(design, simoptions)
%
% Description
%
...
%
%
% See also: completedesign_RADIAL_SLOTLESS.m, simfun_RADIAL.m, simfun_ROTARY.m
%           simfun_AM.m, fr.m
%
%
...
%                     design.ForceGapClosingWithDisp = dot ([solution.blockintegral(18)/2, solution.blockintegral(19)/2], ...
%                                           gvector);
%                                     
