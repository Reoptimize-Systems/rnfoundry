...
%
    ...
    Inputs = setfieldifabsent (Inputs, 'DrawingType', 'MagnetRotation');
            ...
            switch Inputs.ArmatureType
                ...
                case 'external'
                    ...
                    FemmProblem = addarcsegments_mfemm (FemmProblem, ...
                                                        nodeids(2), ...
                                                        nodeids(7), ...
                                                        rad2deg(repmat(2*design.thetap*Inputs.NPolePairs,1,1)));
                    ...
                    if Inputs.DrawOuterRegions
                        ...
                        FemmProblem = addarcsegments_mfemm (FemmProblem, ...
                                                           nodeids([3,4]), ...
                                                           nodeids([6,5]), ...
                                                           rad2deg(repmat(2*design.thetap*Inputs.NPolePairs,1,2)));

                        % Add block labels for the outer air regions
                        [labelloc(1),labelloc(2)]  = pol2cart (design.thetap * Inputs.NPolePairs, Rs + design.ty/2 + routerregion(1)/2);
                        ...
                        [labelloc(1),labelloc(2)]  = pol2cart(design.thetap * Inputs.NPolePairs, Rs + design.ty/2 + routerregion(1) + routerregion(2)/2);
                ...
                case 'internal'
                    ...
                    if linktb
                       ...
                       [FemmProblem, nodeinds, nodeids] = addnodes_mfemm (FemmProblem, ...
                        ...
                        arcangle = design.thetap * Inputs.NPolePairs;
                        ...
                        links = [ nodeids([2,3,4]); ...
                                  nodeids([7,6,5]) ];
                        topnodeid = nodeids(8);
                        arcangle = 2*design.thetap*Inputs.NPolePairs;
                        statorironinds = 1;
                    end
    ...
    switch Inputs.ArmatureType
        ...
        case 'external'
            ...
            [labelloc(1),labelloc(2)]  = pol2cart (design.thetap * Inputs.NPolePairs, design.Rmo+design.g/2);
            ...
            [labelloc(1),labelloc(2)] = pol2cart (design.thetap * Inputs.NPolePairs, Rs);
        ...
        case 'internal'
            ...
            % Add block labels for the air gap
            [labelloc(1),labelloc(2)] = pol2cart (design.thetap * Inputs.NPolePairs, design.Rmi-design.g/2);
