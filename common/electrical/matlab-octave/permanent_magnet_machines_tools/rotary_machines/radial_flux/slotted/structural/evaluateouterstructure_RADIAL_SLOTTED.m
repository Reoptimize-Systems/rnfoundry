...
%                                                      
    ...
    shearforce = -(design.MaxTorquePto / design.OuterStructure.Rsoi) / (2 * pi * design.OuterStructure.Rsoi * design.ls);
    ...
    design.OuterStructMaterialMass = design.StructMaterialVolume * simoptions.evaloptions.StructMaterialDensity;
