function evaloptions = designandevaloptions_TORUS_CORELESS(evaloptions)
% parses the evaloptions structure for the function for rotary machines
%
% Input:
%
...
%
    ...
    evaloptions = designandevaloptions_TORUS(evaloptions);
