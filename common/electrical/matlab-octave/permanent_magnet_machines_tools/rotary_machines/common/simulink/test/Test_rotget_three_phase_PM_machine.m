% Test_rotget_three_phase_PM_machine_dev.mdl
%
%
...
open_system('rotgen_three_phase_pm_machine_dev');

set_param('rotgen_three_phase_pm_machine_dev/Three Phase Rotary PM Machine S-Function', 'UserData', data);
