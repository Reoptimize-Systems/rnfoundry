% Test_rotgen_three_phase_PM_machine_s_function_mdl
%
%
...
open_system('Test_rotgen_three_phase_s_function');

set_param('Test_rotgen_three_phase_s_function/Three Phase Rotary PM Machine S-Function', 'UserData', data);
