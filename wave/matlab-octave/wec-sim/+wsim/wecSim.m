    ...
    methods
        ...
        function prepare (self)
            ...
            if ~has_ext_force
                ...
                all_ext_force_nodes = mbdyn.pre.base.uniqueCells ( [ self.hydroSystem.bodyMBDynNodes, pto_nodes ] );
                
                % add an external sturctural force with the bydro and pto
                % nodes
                ext_force = mbdyn.pre.externalStructuralForce ( all_ext_force_nodes, ...
                                                                [], ...
                                                                communicator, ...
                                                                'Labels', 'no', ...
                                                                'Sorted', 'yes', ...
