function hfig = plotbemio (hydro)
% Plots BEM data and results 
%
% Syntax
%
% wsim.bemio.plotbemio (hydro)
%
% Description
%
...
% Output
%
%  hfig - handles for the 6 resulting figures
%
%
...
Notes = {'Notes:',...
    ...
    'proceeding.']};
FormatPlot(hfig,Title,Subtitles,XLables,YLables,X,Y,Legends,Notes)
waitbar(1/6);

%% Radiation Damping
clear X Y Legends
hfig(2) = figure('Position',[50,300,975,521]);
...
Notes = {'Notes:',...
    ...
    'proceeding.']};
FormatPlot(hfig(2),Title,Subtitles,XLables,YLables,X,Y,Legends,Notes)
waitbar(2/6);

%% Radiation IRFs
clear X Y Legends
hfig(3) = figure('Position',[50,100,975,521]);
...
FormatPlot(hfig(3),Title,Subtitles,XLables,YLables,X,Y,Legends,Notes)
waitbar(3/6);

%% Excitation Force Magnitude
B=1;  % Wave heading index
clear X Y Legends
hfig(4) = figure('Position',[950,500,975,521]);
...
Notes = {''};
FormatPlot(hfig(4),Title,Subtitles,XLables,YLables,X,Y,Legends,Notes)
waitbar(4/6);

%% Excitation Force Phase
B=1;  % Wave heading index
clear X Y Legends
hfig(5) = figure('Position',[950,300,975,521]);
...
Notes = {''};
FormatPlot(hfig(5),Title,Subtitles,XLables,YLables,X,Y,Legends,Notes)
waitbar(5/6);

%% Excitation IRFs
B=1;  % Wave heading index
clear X Y Legends
hfig(6) = figure('Position',[950,100,975,521]);
...
FormatPlot(hfig(6),Title,Subtitles,XLables,YLables,X,Y,Legends,Notes)
waitbar(6/6);
