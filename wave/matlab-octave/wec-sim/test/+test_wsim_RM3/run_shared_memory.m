...
communicator = mbdyn.pre.sharedMemoryCommunicator ('test_wsim_RM3_shared_memory_region', 'yes', ...
                                                   'Coupling', 'tight', ...
                                                   'SleepTime', 0, ...
                                                   'SendAfterPredict', 'no');
...
%         disp(relforcediff)
    ...
    % accept the last data into the rolling time history of solutions
