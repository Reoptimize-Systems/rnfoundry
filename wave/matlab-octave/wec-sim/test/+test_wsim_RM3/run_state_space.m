...
simu.dt = 1; 							%Simulation time-step [s]
...
problem_options.MaxIterations = 20000;
...
problem_options.LinearSolver = mbdyn.pre.linearSolver ('umfpack', 'scale', 'always');
problem_options.SteppingMethod = {'third order', 'ad hoc'};
        
[mbsys, initptodpos] = test_wsim_RM3.make_multibody_system ( ...
    waves, simu, hydro_mbnodes, hydro_mbbodies, hydro_mbelements, problem_options );
...
mbdpath = fullfile (simu.caseDir, 'RM3_state-space-radiation-forces.mbd');
...
% start mbdyn
outputfile_prefix = mbdpath(1:end-4);
