...
% HAWC2 model at a wind speed of 9m/s.
%
% Uses the data file direct_pe_fwt_w09.dat for inputs and for validation.
%
...
% direct_pe_fwt_w09.dat.

v = (direct_pe_fwt_w09(:,109)).';
pitch_angle = (direct_pe_fwt_w09(:,117)).';
...
time_interp = (direct_pe_fwt_w09(:,1) - direct_pe_fwt_w09(1,1)).';
...
% direct_pe_fwt_w09.dat data file input

ang_vel_interp = interp1(t,ang_vel,((direct_pe_fwt_w09(:,1)).'));

% Convert the data angular velocity ouput from rpm to rads/s

data = ((((direct_pe_fwt_w09(:,31)).')/60)*2*pi);

% Set time_data equal to the time input from the direct_pe_fwt_w09.dat 
% data file

time_data = ((direct_pe_fwt_w09(:,1)).');
